# Contoso Electronics Northwind Health Standard Plan
...
5. Track your progress. Keeping track of your weight loss progress can help you to stay
...
foreign country. This includes both medical and dental services. However, it's important to
remember that Northwind Standard does not cover out-of-network services in foreign
countries.
...
employees, and that's why we've partnered with Northwind Health to offer Northwind
Standard, a comprehensive health insurance plan that includes chronic condition
management.
...
work closely with your health care provider to ensure that your condition is being managed
effectively.
...
At Contoso, we want our employees to understand the concept of COB (Coordination of
Benefits) so they can make the best decisions when it comes to their health care coverage.
COB is a system used to determine which health plan pays first when an employee has more
than one health plan.

When an employee has multiple health plans, the health plan that pays first is determined
by the order of benefit determination. Generally, the employee's primary health plan pays
first, followed by the secondary health plan. However, if one of the health plans is a
...
that exceed the limits of the primary plan. For example, if the primary plan has a $1,000
...
There are a few exceptions to the twelve month timely filing limit. These include claims
submitted for newborns, claims submitted for a deceased member, and claims submitted for
services that were provided out-of-country. In these situations, claims may be submitted up
...
with the plan provisions and the process for filing an appeal, gathering all relevant
information, and submitting the appeal within the timeframe specified in the plan are all
...
2. Research other plans. It is important to research other plans and compare them to
   Northwind Standard in order to determine which plan is the best option.

3. Verify the information. If the employee is unsure about the accuracy of any information
...
be reimbursed for the amount they paid. This is a great option for employees who may have
already paid for a service that is covered under the plan and are unaware that they can be
reimbursed.
...
4. Take advantage of preventive care services. Preventive care services are designed to help
