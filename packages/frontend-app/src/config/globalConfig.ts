export const globalConfig = {
  ...
  DEFAULT_PROMPTS: ['Show me some relevant information', 'Give me the answer I seek!', 'Explain me all important details'],
  DEFAULT_PROMPTS_HEADING: 'Start chatting, now!',
